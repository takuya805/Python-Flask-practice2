...
from wtforms import(
    StringField, IntegerField, DateField, PasswordField,
    RadioField, SelectField, BooleanField, TextAreaField, SubmitField
)
...
class UserForm(Form):
    name = StringField('名前：', validators=[validate_name2, DataRequired(
        'データを入力してください')], widget=TextArea(), default='Flask太郎')
    age = IntegerField('年齢：', validators=[NumberRange(0, 120, '正しくない値です')])
    password = PasswordField('パスワード：', validators=[
                             Length(0, 10, '長さは10文字以内です'),
